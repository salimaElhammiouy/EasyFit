...
<p class="titre">Mes Programmes</p>
...
<div class="card" style="width: 18rem;">
  ...
  <div class="card-body">
    ...
    <p><a type="button" href="${ e.nom_prog }.prog">Télécharger Planning   <span><i class="far fa-calendar-alt "  id="icoon"></i></span></a></p>
  </div>
</div>
</div>
</c:forEach> 
...
<p id="v2"><strong>Vous n'avez aucun programme dans votre planning !!</strong>
<br>


<p>Cliquez <a  href="decouvrirProg.do?id=${ sessionScope.sessionUtilisateur }" onmouseover="style.color='#A52A2A'"><strong>ICi</strong></a> pour découvrir nos programmes
</div>
